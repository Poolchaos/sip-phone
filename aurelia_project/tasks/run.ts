...
function runWebpack(done) {
  // Remember to point your Redux Devtools to a custom server with details below
  remotedev({ hostname: '127.0.0.1', port: 6123 });
  // https://webpack.github.io/docs/webpack-dev-server.html
  let opts = {
    host: '127.0.0.1',
    disableHostCheck: true, // allow connecting to developer defined hostname, e.g. /etc/hosts
